...
send(chat_id,0,"\n*⇜ هذه الكروب محظور سوف اغادر جاوو*","md",true)  
...
msalm = "⇜ وسوينا لك حساب في بنك ريكو\n⇜ وشحنالك ٥٠ دينار عراقي 💸 هديه\n\n⇜ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n⇜ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n⇜ فلوسك ↤ ❲ 50 دينار عراقي 💸 ❳\n⇜ شخصيتك ↤ "..shakseshakse.."\n⇜ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
ballance = Redis:get(TheMero.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ريكو سواريز\n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 83\n⇜ الجنسية : اوكرانيا 🇺🇦\n⇜ السعر : 39000 دينار عراقي 💵\n⇜ رصيدك الان : '..convert_mony..' دينار عراقي 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
end
end
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"⇜ تم الغاء شراء اللاعب ريكو سواريز ", 'md', true)
end
end
...
edit(tonumber(UserId[3]),Msg_id,'⇜ تم مسح الرسالة من الكروب', 'md', true)
end
end
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الكروب لعدم تنفيذه العقاب").Reply
...
data = {
{{text = 'Rico 𝖳𝖾𝖺𝖬', url = 't.me/E_16_E'},},}}
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الكروب").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('هذا الامر للمشاركين في لعبة العقاب')..'&show_alert=true')
end
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الكروب لعدم تنفيذه الاحكام").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في الكروب لعدم تنفذه الاحكام").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
local TextHelp = Reply_Status(kk_id,"⇜ تم الغاء كتمه في الكروب").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('هذا الامر للفائز بلعبة الاحكام')..'&show_alert=true')
end
