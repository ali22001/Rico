...
local Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "ريكو")
...
if text == 'ريكو تحبيني' or text =='ريكو تحبني' then
if Redis:get(TheMero.."replayallbot"..msg.chat_id) then
local NamecBots = {
'لا',
'اي',
...
if text == 'ريكو تتزوجيني' or text =='ريكو تتزوجني' then
if Redis:get(TheMero.."replayallbot"..msg.chat_id) then
local NamecBots = {
'تخيل اتزوجك اذلف بس',
...
keyboard.inline_keyboard = {
{
{text = 'Rico 𝖳𝖾𝖺𝖬', url = "https://t.me/E_16_E"}
},
}
...
if text == "انمي" or text == "افتار انمي" then
if Redis:get(TheMero.."trfeh"..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ التسلية معطلة من قبل المشرفين","md",true)
end
local t = "⇜ اخترت لك هذا الافتار"
