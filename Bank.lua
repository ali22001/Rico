...
Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "ريكو")
...
⌯ حسابي  ↢ يطلع لك رقم حسابك حتى تعطيه للشخص اللي بيحول لك
...
ttshakse = '⇜ حتى تسوي حساب اختار نوع بطاقتك'
...
{text = 'Rico 𝖳𝖾𝖺𝖬',url="t.me/E_16_E"}, 
}
}
...
send(msg.chat_id,msg.id, "⇜ فلوسك `"..convert_mony.."`  دينار عراقي 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` دينار عراقي 💵","md",true)
else
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ ريكو ماعندها حساب بالبنك ","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..news.."\n⇜ الحساب ↤ `"..ccccc.."`\n⇜ بنك ↤ ❲ ريكو ❳\n⇜ نوع ❲ "..uuuuu.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." دينار عراقي 💵 ❳\n⇜ الزرف ↤ ❲ "..math.floor(ppppp).." دينار عراقي 💵 ❳\n⇜ مسكين مسحت حسابه","md",true)
else
...
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 100 دينار عراقي 💵\n✧","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 100 دينار عراقي \n✧","md",true)
end
ballancee = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
...
send(msg.chat_id,msg.id, "⇜ حوالة صادرة من بنك ريكو\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المستلم ↤ "..newss.."\n⇜ الحساب رقم ↤ `"..text.."`\n⇜ نوع البطاقة ↤ "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ ↤ "..convert_mony.." دينار عراقي 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك ريكو\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المبلغ ↤ "..convert_mony.." دينار عراقي 💵","md",true)
Redis:del(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheMero.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." دينار عراقي 💵","md",true)
...
bakigcj = ballanceed + jjjo
Redis:set(TheMero.."boob"..msg.sender_id.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ تكرم وهي بخشيش "..jjjo.." دينار عراقي 💵","md",true)
Redis:setex(TheMero.."iioo" .. msg.sender_id.user_id,600, true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تزرفه فلوسه اقل من 200 دينار عراقي 💵","md",true)
end
...
send(msg.chat_id,0, "⇜ "..news.." في حرامي زرفك "..hrame.." دينار عراقي 💵\n⇜ رد عليه بكلمة ( شرطه )\n⇜ معك 30 ثانية\n✧","md",true)
else
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
...
Redis:set(TheMero.."rrfff"..msg.sender_id.user_id,zoroprod)
Redis:sadd(TheMero.."rrfffid",msg.sender_id.user_id)
send(msg.chat_id,msg.id, "⇜ خذ يالحرامي زرفته "..hrame.." دينار عراقي 💵\n✧","md",true)
end
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
end
...
send(msg.chat_id,msg.id,"⇜ كفو مسكته الشرطة 👨‍✈️\n⇜ الحرامي : "..news.."\n⇜ تم اعادة فلوسك : "..tonumber(balcmsrok).." دينار عراقي 💵\n⇜ سيتم سجن الحرامي\n✧","md",true)
else
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 1000000000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : ملك 👑\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 240 then
if tonumber(ballanceed) < 200000000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 200000000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 200000000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : امير 🤵\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 210 then
if tonumber(ballanceed) < 30000000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 30000000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : وزير 🤵\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 180 then
if tonumber(ballanceed) < 1000000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 1000000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : بزنس مان كبير 💸\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 150 then
if tonumber(ballanceed) < 300000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 300000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 300000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : تاجر صغير 💰\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 120 then
if tonumber(ballanceed) < 120000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 120000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 120000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : طيار 👨\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 90 then
if tonumber(ballanceed) < 80000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 80000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 80000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : دكتور 👨\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 60 then
if tonumber(ballanceed) < 30000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
Redis:set(TheMero.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 30000 دينار عراقي 💵\n⇜ اصبحت وظيفتك : صيدلي ‍👨\n⇜ رصيدك الان : "..convert_mony.." دينار عراقي 💵\n✧","md",true)
elseif tonumber(ratbinc) == 30 then
if tonumber(ballanceed) < 3000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 3000 دينار عراقي 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تهجم فلوسك اقل من 100000 دينار عراقي 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تهجم عليه فلوسه اقل من 100000 دينار عراقي 💵","md",true)
end
if tonumber(coniss) < 9999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 10000 دينار عراقي 💵\n✧","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 10000 دينار عراقي \n✧","md",true)
end
ballancee = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
...
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 دينار عراقي 💵\n✧","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
end
...
msgplayer = "⇜ الاسم : ريكو سواريز\n⇜ مركزه : مهاجم ايمن\n⇜ طاقة اللاعب : 83\n⇜ الجنسية : اوكرانيا 🇺🇦\n⇜ سعر اللاعب : 39000 دينار عراقي 💵\n هل ترغب بشراء اللاعب ؟\n✧"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:sismember(TheMero.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة ريكو :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 دينار عراقي 💵\n- بندوره : 100 دينار عراقي 💵\n- خس : 125 دينار عراقي 💵\n- خيار : 150 دينار عراقي 💵\n- جزر : 175 دينار عراقي 💵\n- فليفله : 200 دينار عراقي 💵\n- فريز : 300 دينار عراقي 💵\n- ذره : 400 دينار عراقي 💵\n- ثوم : 500 دينار عراقي 💵\n- فطر : 800 دينار عراقي 💵\n- شجره تفاح : 1000 دينار عراقي 💵\n- شجره عنب : 1250 دينار عراقي 💵\n-شجره زيتون : 1500 دينار عراقي 💵\n- شجره موز : 2000 دينار عراقي 💵\n- شجره مانجا : 3000 دينار عراقي 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@E_16_E")
sleep(1)
...
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ الاسم ↢ "..news.."\n⇜ الحساب ↢ "..ccccc.."\n⇜ بنك ↢ ( ريكو )\n⇜ نوع ↢ ( "..uuuuu.." )\n⇜ الزرف ↢ ( "..ppppp.." دولار 💵 )\n⇜ صار رصيده ↢ ( "..convert_mony.." دينار عراقي 💵 )\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
end
end
...
ballanceed = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) > 1000000001 then
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح هو مليار دينار عراقي 💵\n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 دينار عراقي 💵\n✧","md",true)
end
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ ريكو ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(TheMero.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
...
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح به هو 10000 دينار عراقي \n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 1000 دينار عراقي \n✧","md",true)
end
if Redis:ttl(TheMero.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."tabrotime" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ يمديك تتبرع بعد "..time.." ","md",true)
...
tttt = "⌯ وصل تبرع 📄\n\n⇜ من : "..news.."\n⇜ المستفيد : "..user_name.."\n⇜ المبلغ : "..convert_mony.." دينار عراقي 💵 \n⇜ فلوس المستفيد الان : "..convert_monyy.." دينار عراقي 💵\n✧"
...
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id, "⇜ تبرعاتك : `"..convert_mony.."` دينار عراقي 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
